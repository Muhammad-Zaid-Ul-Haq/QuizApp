...
return(
<div className="app">
{false ?(<div className="score-section">You Scored ! out Of{question}):(
<>
...
<div className="answer-section">{question[0].ansOP.map{(answerOption)=>(
<button onCLick={handleAnswerBt}>{answerOp.isCorrect}</button>)}}
</div>
</>
</div>
)
